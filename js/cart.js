...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const deliveryCharges = {
        "near_to_siragate": 20,
        "near_to_shridevi_college": 30, "near_to_satyamangala": 40, "near_to_golds_gym": 30, "near_to_Chickpet": 30, "near_to_mandipet": 40,
        "near_to_ss_puram": 50, "near_to_mg_road": 40, "near_to_siddaganga_hospital": 50, "near_to_antharasanahalli": 40,
        "near_to_stadium": 50, "near_to_hanumanthpura": 50, "near_to_caltex": 40,"near_to_SP_Office": 50,
        "near_to_sit": 60, "near_to_jayanagar": 60, "near_to_sapthagiri_extension": 60, "near_to_banshankri": 50,
        "near_to_upparhalli": 50, "near_to_ssit": 60, "near_to_Danah_palace": 50,
        "near_to_ssmc": 70, "near_to_shettihalli": 70, "near_to_batwadi": 70, "near_to_kyatsandra": 80, "near_to_belagumba": 60, "near_to_hirehalli": 100
    };
    ...
    if (toggleBreakdown) {
        toggleBreakdown.addEventListener("click", () => {
            ...
            if (breakdown.style.display === "none") {
                ...
                toggleBreakdown.textContent = "▲ Bill Summary";
            } else {
...
//        user_gym: billingDetails.gym,
        ...
        service_charges: billingDetails.servicecharges,
